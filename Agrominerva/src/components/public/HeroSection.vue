<template>
  <section class="relative bg-tertiary-700 text-white min-h-[75vh] md:min-h-[85vh] flex items-center overflow-hidden">
    ...
    <!-- Gradient Overlay -->
    <div class="absolute inset-0 bg-gradient-to-br from-tertiary-800/50 via-tertiary-700/30 to-primary-900/40 z-0">
    </div>
      ...
      <div class="grid md:grid-cols-2 gap-12 md:gap-16 lg:gap-20 items-center">
        ...
        <div class="text-left space-y-7 animate-fade-in">
          ...
          <p class="text-lg md:text-xl text-white/90 leading-relaxed max-w-xl font-light">
            Formando profesionales agronómicos con <span class="font-semibold text-primary-300">excelencia
              académica</span> y compromiso social, capacitados para impulsar el desarrollo agrícola sostenible de la
            región oriental.
          </p>
        ...
        <div class="relative flex justify-center md:justify-end animate-slide-in">
          <div class="relative group">
            ...
            <div
              ...
              <video v-if="showVideo" ref="videoElement" src="" class="w-full h-full object-cover" :muted="isMuted"
                autoplay loop playsinline></video>

              <!-- Imagen de respaldo -->
              <img v-else src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=360&h=640&fit=crop"
                alt="Departamento de Agronomía" class="w-full h-full object-cover" />
              ...
              <button v-if="showVideo" @click="toggleMute"
